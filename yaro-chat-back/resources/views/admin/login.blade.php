...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg alert alert-success">{{ session()->get('success') }}</p>
    @elseif(session()->has('error'))
      <p class="login-box-msg alert alert-danger">{{ session()->get('error') }}
    @endif
    ...
    <a href="{{ aurl('forget_password') }}">I forgot my password</a><br>
